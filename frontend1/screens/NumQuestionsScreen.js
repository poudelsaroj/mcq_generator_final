...
import { generateMCQsFromAPI, getBaseUrl } from '../services/apiService'; // Import getBaseUrl here
...
const NumQuestionsScreen = ({ navigation, route }) => {
  ...
  const { contentType, content, fileUri, fileName, fileType } = route.params || {};
  ...
  const handleGenerateMCQs = async () => {
    ...
    try {
      ...
      const mcqs = await generateMCQsFromAPI(content, numQuestions);
